    ...
    <div v-for="globaldata in datauser" :key="globaldata.ID">
      <v-card class="bg-grey-lighten-5 pa-2" variant="tonal">
        ...
        <div class="w-100 pa-2">
          ...
          <p class="text-black">Proof Details: {{ globaldata.ProofDtails }}</p>
...
const userdata=async()=>{
      ...
      const apiurl='https://vaanam.w3webtechnologies.co.in/loandb/getlastdata_close.php'
  ...
  const filterdata=async(filtervalue)=>{
    loading.value=true
    datashow.value=false
    const apiurl='https://vaanam.w3webtechnologies.co.in/loandb/loansearchdata_close.php'
