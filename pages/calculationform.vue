        ...
        <div class="d-flex justify-space-between flex-column pa-1" :style="{ height: box2Height + 'px' }">
          ...
          <div>
            ...
            <div class="w-100 d-flex ga-2">
              <v-text-field label="Given Amount" type="number" v-model="givenamount"
          ...
          <div class="w-100 pa-1  d-flex ga-1">
            ...
            <div class="w-100"><v-btn  class="btn bg-green" type="submit" block>Submit & Close</v-btn></div>
          </div>
        </div>
          ...
          <v-tabs-window v-model="tab">
                ...
                <v-col class="pa-1" cols="4">
                  <div class="w-100 bg-white rounded-lg" style="height: 90px;">
                    <div class="w-100 bg-white rounded-lg " style="height: 90px;">
                      ...
                      <div class="w-100 bg-indigo" style="height: 5px;"></div>
                      <span class="text-h6 text-indigo"><b>{{ advvalue }}.00 (=)</b></span>
                      <div class="w-100 bg-indigo" style="height: 5px;"></div>
                    </div>
                  </div>
                </v-col>
            ...
            <v-tabs-window-item value="three">
              ...
              <div class="w-100 mt-2 d-flex ga-2">
                ...
                <div class="w-50 pa-1 bg-white rounded-lg ">
                  ...
                  <div class="w-100 bg-pink-darken-4" style="height: 5px;"></div>
                  <p class="text-white text-h6 bg-pink-darken-4 mt-1 text-right">{{ interest }}</p>
              ...
              <div class="w-100 pa-1 d-flex justify-end ga-2">
                ...
                <div class="w-25 pa-1 bg-black rounded-lg d-flex justify-start">
                  <p class="text-left text-h6 text-white ">{{ totmonth }}</p>
                </div>
                <div class="w-50 pa-1 bg-black rounded-lg d-flex justify-end">
                  <p class="text-right text-h6 text-white ">{{ interest }}</p>
                </div>
              </div>
            </v-tabs-window-item>
            <v-tabs-window-item value="four" class="pa-2">
              ...
              <div class="w-100 pa-1 mt-2 d-flex ga-2">
                ...
                <div class="w-25 pa-1 bg-white rounded-lg" style="border-bottom: 3px solid rebeccapurple;">
                  <p class="text-left text-h6 text-pink-darken-4">{{ interest }}</p>
                </div>
              </div>
              ...
              <div class="w-100 pa-1 mt-2 d-flex ga-2">
                <div class="w-50 pa-1 bg-indigo rounded-lg">
                  <p class="text-left text-h6 text-white">Collected Amount</p>
                </div>
                <div class="w-50 pa-1 bg-indigo rounded-lg" style="border-bottom: 3px solid rebeccapurple;">
                  <p class="text-right text-h6 text-white ">{{ total }}</p>
                </div>
              </div>
            </v-tabs-window-item>
          </v-tabs-window>
...
const calculation = (loandate) => {
  ...
  const p_totalmonths = totalmonths - advvalue.value
  const totalintrest = parseFloat((p_totalmonths * monthly_intrest).toFixed(2))
  ...
  totmonth.value = p_totalmonths
  const intamount = perval.value * totmonth.value
  interest.value = Math.ceil(intamount * 100) / 100
...
const getadvancemonth = async () => {
  ...
  try {
    ...
    advvalue.value = data.AdvanceMonths
...
const calculationsubmission = async (mode) => {
 ...
 formdata.append('loanappid',loanappid.value );
  ...
  formdata.append('inamoutn', in_amount.value);
  ...
  try {
   ...
   loading.value = false;
    ...
    successmesage.value = 'Data submitted successfully';
    setTimeout(() => {
...
const statusclose = async () => {
  const apiUrl = 'https:///vaanam.w3webtechnologies.co.in/loandb/closed.php';
  const formData = new FormData();
